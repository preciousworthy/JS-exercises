...
//console.log(exercise4(3,4));
//console.log(exercise4(3,3));
//console.log(exercise4('four', 4));
...
// exercise4('four', 4) would return varA and varB differ. Even though the values are the same thing, they're not exactly the same value. The same goes for ex. exercise4('null', null) One is a string and the other is a boolean so answer4 would be varA and varB differ.
...
//console.log(exercise8(3, 8, 0, 10));
...
//console.log(exercise10(33));
//console.log(exercise10(45));
//console.log(exercise10(78));
...
// These exercises were pretty challenging, but it felt really good to figure them out on my own. For help, I used mdn Web Docs. 
